...
class ProductFitment extends Model
{
    ...
    public function generation(): BelongsTo { return $this->belongsTo(VehicleGeneration::class, 'vehicle_generation_id'); }
    public function trim(): BelongsTo { return $this->belongsTo(VehicleTrim::class, 'vehicle_trim_id'); }
    public function engine(): BelongsTo { return $this->belongsTo(VehicleEngine::class, 'vehicle_engine_id'); }
}
